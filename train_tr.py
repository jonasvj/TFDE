...
from models import TensorRingAlt
...
def cli():
    parser = argparse.ArgumentParser(
        ...
        allow_abbrev=False,
        description='Script for training Tensor Ring model')
    ...
    parser.add_argument(
        '--K',
        help='Choice of K for tensor ring model.',
        type=int,
        default=10
    )
    parser.add_argument(
...
if __name__ == '__main__':
    ...
    Ks = [args.K]*(data_train.shape[1])
    model = TensorRingAlt(Ks=Ks, device=device)
    model.hot_start(
